...
// // static
// operation operation::factory_from_data_stream(std::istream& stream)
// {
//     operation instance;
//     instance.from_data_stream(stream);
//     return instance;
// }
...
// bool operation::from_data_stream(std::istream& stream)
// {
...
// void operation::to_data_stream(std::ostream& stream) const
// {
