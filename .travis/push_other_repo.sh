...
replace_versions bitprim-infrastructure $BITPRIM_BUILD_NUMBER

cat versions.txt
git add . versions.txt
git commit --message "Travis bitprim-infrastructure build: $BITPRIM_BUILD_NUMBER, $TRAVIS_BUILD_NUMBER" || true
