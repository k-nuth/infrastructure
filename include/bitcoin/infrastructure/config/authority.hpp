 ...
 */
#ifndef LIBBITCOIN_INFRASTUCTURE_CONFIG_AUTHORITY_HPP
#define LIBBITCOIN_INFRASTUCTURE_CONFIG_AUTHORITY_HPP
...
public:
     ...
     */
    // implicit //Note(knuth): in knuth-network it is used the implicit convertion
