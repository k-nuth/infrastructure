 ...
 */
#ifndef BITPRIM_INFRASTRUCTURE_UNICODE_STREAMBUF_HPP
#define BITPRIM_INFRASTRUCTURE_UNICODE_STREAMBUF_HPP
...
protected:
     ...
     */
    virtual std::streambuf::int_type overflow(std::streambuf::int_type character);
