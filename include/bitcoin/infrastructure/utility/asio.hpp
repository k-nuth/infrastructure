 ...
 */
#ifndef LIBBITCOIN_INFRASTRUCTURE_ASIO_HPP
#define LIBBITCOIN_INFRASTRUCTURE_ASIO_HPP
...
BI_CONSTEXPR int max_connections = boost::asio::socket_base::max_connections;
