 ...
 */
#ifndef LIBBITCOIN_INFRASTRUCTURE_CONSTANTS_HPP
#define LIBBITCOIN_INFRASTRUCTURE_CONSTANTS_HPP
...
BI_CONSTEXPR uint32_t retarget_proof_of_work_limit = 0x1e0fffff; 
BI_CONSTEXPR uint32_t no_retarget_proof_of_work_limit = 0x207fffff; // TODO: merge version3. check the no_retarget value for LTC 
#else // BITPRIM_CURRENCY_LTC
BI_CONSTEXPR size_t max_work_bits = 0x1d00ffff;
BI_CONSTEXPR uint32_t retarget_proof_of_work_limit = 0x1d00ffff;
BI_CONSTEXPR uint32_t no_retarget_proof_of_work_limit = 0x207fffff;
