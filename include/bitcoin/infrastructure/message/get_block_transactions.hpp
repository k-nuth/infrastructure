 ...
 */
#ifndef LIBBITCOIN_INFRASTRUCTURE_MESSAGE_GET_BLOCK_TRANSACTIONS_HPP
#define LIBBITCOIN_INFRASTRUCTURE_MESSAGE_GET_BLOCK_TRANSACTIONS_HPP
...
class BI_API get_block_transactions
{
public:
