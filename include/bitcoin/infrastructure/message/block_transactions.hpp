 ...
 */
#ifndef LIBBITCOIN_INFRASTRUCTURE_MESSAGE_BLOCK_TRANSACTIONS_HPP
#define LIBBITCOIN_INFRASTRUCTURE_MESSAGE_BLOCK_TRANSACTIONS_HPP
...
class BI_API block_transactions
{
public:
