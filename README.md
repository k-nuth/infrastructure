...
```
$ conan install --requires=infrastructure/0.25.0 --update
```
...
[badge.GhA]: https://github.com/k-nuth/infrastructure/workflows/Build%20and%20Test/badge.svg?branch=master
